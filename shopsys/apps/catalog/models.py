...
class Product(models.Model):
    name = models.CharField("名称", max_length=225, unique=True)
    slug = models.SlugField(
        "Slug",
    ...
    price = models.DecimalField("价格", max_digits=60, decimal_places=2)
    old_price = models.DecimalField(
        "原来价格",
        max_digits=60, decimal_places=2, blank=True, default=0.00)
    image = models.ImageField("图片", max_length=50)
    is_active = models.BooleanField("设为激活", default=True)
    is_featured = models.BooleanField("标为畅销", default=False)
